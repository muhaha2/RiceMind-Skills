...
Before generating any report, read `references/report-template.md` and `references/ricemind-api.md`. Use the extracted API guide `references/ricemind-api-guide.md` when endpoint fields, route background, or model-level details are unclear.
...
- `references/ricemind-api-guide.md`: condensed Markdown version of the user-provided API documentation, including route overview, model fields, common parameters, and non-core endpoint notes.
