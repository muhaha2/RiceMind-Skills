...
Use this reference before calling the RiceMind REST service. Additional route background from the user-provided API documentation is preserved in `references/ricemind-api-guide.md`.
